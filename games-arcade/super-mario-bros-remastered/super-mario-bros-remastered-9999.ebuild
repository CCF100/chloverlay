...
inherit desktop wrapper xdg git-r3
...
SRC_URI="https://github.com/godotengine/godot-builds/releases/download/${GODOT_VERSION}-stable/Godot_v${GODOT_VERSION}-stable_export_templates.tpz"

#S="${WORKDIR}/Super-Mario-Bros.-Remastered-Public-${MY_PV}"
EGIT_REPO_URI="https://github.com/JHDev2006/Super-Mario-Bros.-Remastered-Public.git"
EGIT_BRANCH="1.1"
