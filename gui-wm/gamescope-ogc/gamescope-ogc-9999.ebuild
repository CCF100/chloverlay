...
DESCRIPTION="Efficient micro-compositor for running games (OpenGamingCollective's fork)"
HOMEPAGE="https://github.com/OpenGamingCollective/gamescope"
...
PATCHES=(
	"${FILESDIR}/glm-stb-include-for-gentoo.patch"
)
